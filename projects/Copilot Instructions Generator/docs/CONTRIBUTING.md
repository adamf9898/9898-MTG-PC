...
We welcome contributions from the Magic: The Gathering and gaming community!

# Getting Started

Contributions can be made in the form of:
   - **Instructions**: Custom guidelines to tailor the behavior for specific technologies, coding practices, or domains.
   -  **Prompts**: Ready-to-use templates for specific development scenarios and tasks.
   - **Chat Modes**: Specialized configurations that transform GitHub Copilot Chat into domain-specific assistants or personas.
  - **Agents**: Configurations that enable GitHub Copilot to perform complex, multi-step tasks autonomously.
  - **Scripts**: Automation scripts to streamline GitHub Copilot workflows and tasks.
  - **Workspaces**: Predefined project setups that optimize GitHub Copilot for specific development environments.
  - **Collections**: Curated sets of instructions, prompts, chat modes, agents, scripts, and/or workspaces for particular uses or technologies.

## Coding Standards

- Use modern ES6+ JavaScript
- Semantic HTML5 and accessible CSS
...
Instructions help customize behavior for specific technologies, coding practices, or domains.
...
4. **Test your instructions**: Make sure your instructions work well.
...
name: `name`
description: `A brief summary describing the instructions`
type: `type`
mode: [`agent`, `chat`, `instruction`, `prompt`, `script`, `workspace`, `collection`, `other`]
tools: [`codebase`, `terminalCommand`], `# specify relevant tools`

---

```

# Instructions for ${name} Contribution
...
You have extensive expertise in this area, including best practices, common pitfalls, and advanced techniques.
